...
!(function(t, e, n, o) {
    ...
    var i = {
            ...
            baseClass: "",
            slideClass: "",
            baseTpl: '<div class="fancybox-container" role="dialog" tabindex="-1"><div class="fancybox-bg"></div><div class="fancybox-caption-wrap"><div class="fancybox-caption"></div></div><div class="fancybox-controls"><div class="fancybox-infobar"><button data-fancybox-previous class="fancybox-button fancybox-button--left" title="Previous"></button><div class="fancybox-infobar__body"><span class="js-fancybox-index"></span>&nbsp;/&nbsp;<span class="js-fancybox-count"></span></div><button data-fancybox-next class="fancybox-button fancybox-button--right" title="Next"></button></div><div class="fancybox-buttons"><button data-fancybox-close class="fancybox-button fancybox-button--close" title="Close (Esc)"></button></div></div><div class="fancybox-slider-wrap"><div class="fancybox-slider"></div></div></div>',
    ...
    n.extend(p.prototype, {
            ...
            createGroup: function(t) {
                ...
                n.each(s, function(t, s) {
                    ...
                    n.isPlainObject(s) ?
                        ...
                        l.opts.$orig && !l.opts.$orig.length && delete l.opts.$orig, !l.opts.$thumb &&
                        l.opts.$orig &&
            ...
            jumpTo: function(t, e) {
                ...
                if (
                    ((n = r.firstRun = null === r.firstRun),
                        (s = i = t = parseInt(t, 10)),
                        (a = !!r.current && r.current.opts.loop), !r.isAnimating && (s != r.currIndex || n))
                ) {
            ...
            createSlide: function(t) {
                ...
                if (
                    ((o = t % i.group.length),
                        (o = o < 0 ? i.group.length + o : o), !i.slides[t] && i.group[o])
                ) {
            ...
            scaleToActual: function(t, e, s) {
                ...
                p &&
                    ((u.isAnimating = !0),
                        ...
                        n.fancybox.animate(
                            p,
                            null, { top: r, left: a, scaleX: c, scaleY: l },
                            s || d.opts.speed,
                            function() {
                                u.isAnimating = !1;
                            }
            ...
            getFitPos: function(t) {
                ...
                return (!(!u || !u.length || (!d && !p)) &&
                    ("number" === n.type(h) && (h = [h, h]),
                        ...
                        (r = Math.floor(0.5 * (e - c)) + h[3]), { top: i, left: r, width: c, height: l })
                );
            },
                    ...
                    ((t.isRevealed = !0),
                        void(
                            ...
                            (t.$ghost && !t.isLoaded && o.updateSlide(t, !0),
                                t.pos === o.currPos ?
                                n.fancybox.animate(
                                    t.$placeholder, { opacity: 0 }, { opacity: 1 },
                                    300,
                                    e
                                ) :
                                t.$placeholder.show(),
                            ...
                            if (1 === e[0].isReady) {
                                ...
                                s &&
                                    ...
                                    ((a =
                                        ...
                                        l.css({
                                            width: i.css.width === o ?
                                                r + (l.outerWidth() - l.innerWidth()) : i.css.width,
                                            height: i.css.height === o ?
                                                c + (l.outerHeight() - l.innerHeight()) : i.css.height
                                        })),
            ...
            getTranslate: function(t) {
                ...
                return (!(!t || !t.length) &&
                    ((e = t.get(0).getBoundingClientRect()),
                        ...
                        n.length ?
                        ((n =
                                n.length > 10 ? [n[13], n[12], n[0], n[5]] : [n[5], n[4], n[0], n[3]]),
                            (n = n.map(parseFloat))) :
                        (n = [0, 0, 1, 1]), {
                            top: n[0],
                            left: n[1],
    ...
    var o = (function() {
        ...
        c = function(t) {
            for (var e = !1;;) {
                ...
                if (
                    ((t = t.parent()), !t.length || t.hasClass("fancybox-slider") || t.is("body"))
                )
                    break;
            }
            return e;
    ...
    (l.prototype.limitMovement = function(t, e, n, o) {
        ...
        return (
            ...
            (f > 0 && e > i && (e = i - 1 + Math.pow(-i + p + f, 0.8) || 0),
                f < 0 && e < r && (e = r + 1 - Math.pow(r - p - f, 0.8) || 0)), { top: e, left: t }
        );
    }),
    ...
    (l.prototype.ontap = function() {
        ...
        if (
            ((s -= t.$wrap.offset().left),
                (i -= t.$wrap.offset().top),
                e.SlideShow && e.SlideShow.isActive && e.SlideShow.stop(), !n.fancybox.isTouch)
        )
